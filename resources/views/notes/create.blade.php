        ...
        <form method="POST" action="{{ route("notes.ajouter") }}" class="w-full">
            ...
            <div class="flex w-full justify-center flex-wrap mb-8">
                <div class="flex w-8/12 justify-center flex-wrap">
                    ...
                    <input type="text" class="w-full rounded-2xl dark:bg-gray-700 border-2 border-t-gray-100 border-l-gray-100 border-b-zinc-400 border-r-zinc-400 px-6" name="title" required>
                </div>
            </div>
            <div class="flex w-full justify-center flex-wrap mb-8">
                <div class="flex w-8/12 justify-center flex-wrap">
                    <label class="text-2xl dark:text-gray-200" >Contenu</label>
                    <input type="text" class="w-full rounded-2xl dark:bg-gray-700 border-2 border-t-gray-100 border-l-gray-100 border-b-zinc-400 border-r-zinc-400 px-6" name="content" required>
                </div>
            </div>
